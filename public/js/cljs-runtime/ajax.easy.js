...
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.first(format),(function (){var G__24641 = cljs.core.second(format);
var G__24642 = format_params;
return (ajax.easy.keyword_response_format_element.cljs$core$IFn$_invoke$arity$2 ? ajax.easy.keyword_response_format_element.cljs$core$IFn$_invoke$arity$2(G__24641,G__24642) : ajax.easy.keyword_response_format_element.call(null,G__24641,G__24642));
})()], null);
} else {
if(cljs.core.map_QMARK_(format)){
return format;
...
var G__24643 = format;
var G__24643__$1 = (((G__24643 instanceof cljs.core.Keyword))?G__24643.fqn:null);
switch (G__24643__$1) {
case "transit":
...
if(cljs.core.vector_QMARK_(format)){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.vector,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__24644_SHARP_){
return ajax.easy.keyword_response_format_element(p1__24644_SHARP_,format_params);
}),format));
} else {
 ...
 */
ajax.easy.transform_handler = (function ajax$easy$transform_handler(p__24667){
var map__24668 = p__24667;
var map__24668__$1 = cljs.core.__destructure_map(map__24668);
var handler = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__24668__$1,new cljs.core.Keyword(null,"handler","handler",-195596612));
var error_handler = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__24668__$1,new cljs.core.Keyword(null,"error-handler","error-handler",-484945776));
var finally$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__24668__$1,new cljs.core.Keyword(null,"finally","finally",1589088705));
var h = (function (){var or__4998__auto__ = handler;
...
var e = (function (){var or__4998__auto__ = error_handler;
if(cljs.core.truth_(or__4998__auto__)){
return or__4998__auto__;
} else {
...
return (function ajax$easy$transform_handler_$_easy_handler(p__24678){
var vec__24683 = p__24678;
var ok = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__24683,(0),null);
var result = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__24683,(1),null);
var fexpr__24691_24783 = (cljs.core.truth_(ok)?h:e);
(fexpr__24691_24783.cljs$core$IFn$_invoke$arity$1 ? fexpr__24691_24783.cljs$core$IFn$_invoke$arity$1(result) : fexpr__24691_24783.call(null,result));
 ...
 */
ajax.easy.transform_opts = (function ajax$easy$transform_opts(p__24692){
var map__24693 = p__24692;
var map__24693__$1 = cljs.core.__destructure_map(map__24693);
var opts = map__24693__$1;
var method = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__24693__$1,new cljs.core.Keyword(null,"method","method",55703592));
var format = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__24693__$1,new cljs.core.Keyword(null,"format","format",-1306924766));
var response_format = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__24693__$1,new cljs.core.Keyword(null,"response-format","response-format",1664465322));
var params = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__24693__$1,new cljs.core.Keyword(null,"params","params",710516235));
var body = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__24693__$1,new cljs.core.Keyword(null,"body","body",-2049205669));
var needs_format = (((body == null)) && (cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(method,"GET")));
var rf = (cljs.core.truth_((function (){var or__4998__auto__ = format;
if(cljs.core.truth_(or__4998__auto__)){
return or__4998__auto__;
} else {
return needs_format;
