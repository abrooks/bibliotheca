...
var self__ = this;
var this$ = this;
var n__5589__auto__ = self__.length;
var x = (0);
while(true){
if((x < n__5589__auto__)){
var v_26429 = this$.pop();
if((keep_QMARK_.cljs$core$IFn$_invoke$arity$1 ? keep_QMARK_.cljs$core$IFn$_invoke$arity$1(v_26429) : keep_QMARK_.call(null,v_26429))){
this$.unshift(v_26429);
} else {
}
...
return cljs.core._write(writer__5284__auto__,"cljs.core.async.impl.buffers/RingBuffer");
}));
...
return cljs.core._write(writer__5284__auto__,"cljs.core.async.impl.buffers/FixedBuffer");
}));
...
return cljs.core._write(writer__5284__auto__,"cljs.core.async.impl.buffers/DroppingBuffer");
}));
...
return cljs.core._write(writer__5284__auto__,"cljs.core.async.impl.buffers/SlidingBuffer");
}));
...
return cljs.core._write(writer__5284__auto__,"cljs.core.async.impl.buffers/PromiseBuffer");
}));
