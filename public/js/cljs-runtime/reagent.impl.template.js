...
(reagent.impl.template.NativeWrapper.cljs$lang$ctorPrWriter = (function (this__5283__auto__,writer__5284__auto__,opt__5285__auto__){
return cljs.core._write(writer__5284__auto__,"reagent.impl.template/NativeWrapper");
}));
...
var G__22115 = o;
reagent.impl.template.goog$module$goog$object.set(G__22115,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
G__22163.cljs$lang$applyTo = (function (arglist__22167){
var args = cljs.core.seq(arglist__22167);
...
var G__22122 = o;
reagent.impl.template.goog$module$goog$object.set(G__22122,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
var G__22126 = props;
var G__22126__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__22126,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__22126);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__22126__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,(function (){var or__4998__auto__ = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__22127 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__22127,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__22127;
}
})(),id_class);
...
var G__22128 = (cljs.core.count(argv) - first_child);
switch (G__22128) {
case (0):
...
(reagent.impl.template.HiccupTag.cljs$lang$ctorPrWriter = (function (this__5283__auto__,writer__5284__auto__,opt__5285__auto__){
return cljs.core._write(writer__5284__auto__,"reagent.impl.template/HiccupTag");
}));
...
var vec__22129 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22129,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22129,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22129,(2),null);
...
var temp__5808__auto___22185 = reagent.impl.util.react_key_from_vec(v);
if((temp__5808__auto___22185 == null)){
} else {
var key_22186 = temp__5808__auto___22185;
(jsprops.key = key_22186);
}
...
var temp__5808__auto___22188 = reagent.impl.util.react_key_from_vec(v);
if((temp__5808__auto___22188 == null)){
} else {
var key_22189 = temp__5808__auto___22188;
(jsprops.key = key_22189);
}
...
var jsprops = (function (){var or__4998__auto__ = reagent.impl.template.convert_prop_value(((hasprops)?props:null));
if(cljs.core.truth_(or__4998__auto__)){
return or__4998__auto__;
} else {
return ({});
...
var temp__5808__auto___22194 = reagent.impl.util.react_key_from_vec(argv);
if((temp__5808__auto___22194 == null)){
} else {
var key_22195 = temp__5808__auto___22194;
(jsprops.key = key_22195);
}
...
var hasprops = (((props == null)) || (cljs.core.map_QMARK_(props)));
var jsprops = (function (){var or__4998__auto__ = reagent.impl.template.convert_props(((hasprops)?props:null),parsed);
if(cljs.core.truth_(or__4998__auto__)){
return or__4998__auto__;
} else {
return ({});
...
var input_class = (function (){var or__4998__auto__ = compiler.reagentInput;
if(cljs.core.truth_(or__4998__auto__)){
return or__4998__auto__;
} else {
...
var temp__5808__auto___22212 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5808__auto___22212 == null)){
} else {
var key_22213 = temp__5808__auto___22212;
(jsprops.key = key_22213);
}
...
var jsprops = (function (){var or__4998__auto__ = props;
if(cljs.core.truth_(or__4998__auto__)){
return or__4998__auto__;
} else {
return ({});
...
var temp__5808__auto___22214 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5808__auto___22214 == null)){
} else {
var key_22215 = temp__5808__auto___22214;
(jsprops.key = key_22215);
}
...
return cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__22132_SHARP_){
return reagent.impl.protocols.as_element(compiler,p1__22132_SHARP_);
}),s));
});
...
var ctx = ({});
var vec__22133 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx,compiler);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22133,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22133,(1),null);
...
*/
reagent.impl.template.t_reagent$impl$template22146 = (function (opts,id,fn_to_element,parse_fn,meta22147){
this.opts = opts;
this.id = id;
...
(reagent.impl.template.t_reagent$impl$template22146.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_22148,meta22147__$1){
var self__ = this;
var _22148__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template22146(self__.opts,self__.id,self__.fn_to_element,self__.parse_fn,meta22147__$1));
}));

(reagent.impl.template.t_reagent$impl$template22146.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_22148){
var self__ = this;
var _22148__$1 = this;
return self__.meta22147;
}));

(reagent.impl.template.t_reagent$impl$template22146.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template22146.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template22146.prototype.reagent$impl$protocols$Compiler$parse_tag$arity$3 = (function (this$,tag_name,tag_value){
var self__ = this;
var this$__$1 = this;
...
(reagent.impl.template.t_reagent$impl$template22146.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element(this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template22146.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element(this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template22146.getBasis = (function (){
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"opts","opts",1795607228,null),new cljs.core.Symbol(null,"id","id",252129435,null),new cljs.core.Symbol(null,"fn-to-element","fn-to-element",-1764467095,null),new cljs.core.Symbol(null,"parse-fn","parse-fn",-836029424,null),new cljs.core.Symbol(null,"meta22147","meta22147",1053581427,null)], null);
}));

(reagent.impl.template.t_reagent$impl$template22146.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template22146.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template22146");

(reagent.impl.template.t_reagent$impl$template22146.cljs$lang$ctorPrWriter = (function (this__5283__auto__,writer__5284__auto__,opt__5285__auto__){
return cljs.core._write(writer__5284__auto__,"reagent.impl.template/t_reagent$impl$template22146");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template22146.
 */
reagent.impl.template.__GT_t_reagent$impl$template22146 = (function reagent$impl$template$__GT_t_reagent$impl$template22146(opts,id,fn_to_element,parse_fn,meta22147){
return (new reagent.impl.template.t_reagent$impl$template22146(opts,id,fn_to_element,parse_fn,meta22147));
});
...
return (new reagent.impl.template.t_reagent$impl$template22146(opts,id,fn_to_element,parse_fn,cljs.core.PersistentArrayMap.EMPTY));
});
