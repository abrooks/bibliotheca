...
var G__24462 = request;
var G__24463 = cljs.core.second(format_entry);
return (ajax.formats.get_format.cljs$core$IFn$_invoke$arity$2 ? ajax.formats.get_format.cljs$core$IFn$_invoke$arity$2(G__24462,G__24463) : ajax.formats.get_format.call(null,G__24462,G__24463));
} else {
...
return cljs.core.some((function (p1__24484_SHARP_){
return ajax.formats.content_type_matches(content_type,p1__24484_SHARP_);
}),accept);
});
ajax.formats.get_default_format = (function ajax$formats$get_default_format(response,p__24489){
var map__24490 = p__24489;
var map__24490__$1 = cljs.core.__destructure_map(map__24490);
var request = map__24490__$1;
var response_format = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__24490__$1,new cljs.core.Keyword(null,"response-format","response-format",1664465322));
...
var fexpr__24492 = new cljs.core.Keyword(null,"read","read",1140058661).cljs$core$IFn$_invoke$arity$1(format);
return (fexpr__24492.cljs$core$IFn$_invoke$arity$1 ? fexpr__24492.cljs$core$IFn$_invoke$arity$1(response) : fexpr__24492.call(null,response));
});
});
ajax.formats.accept_header = (function ajax$formats$accept_header(p__24497){
var map__24499 = p__24497;
var map__24499__$1 = cljs.core.__destructure_map(map__24499);
var request = map__24499__$1;
var response_format = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__24499__$1,new cljs.core.Keyword(null,"response-format","response-format",1664465322));
...
return cljs.core.mapcat.cljs$core$IFn$_invoke$arity$variadic((function (p1__24493_SHARP_){
return ajax.formats.get_accept_entries(request,p1__24493_SHARP_);
