...
return [(function (){var pred__22491 = cljs.core.instance_QMARK_;
var expr__22492 = reactive_val;
if(cljs.core.truth_((pred__22491.cljs$core$IFn$_invoke$arity$2 ? pred__22491.cljs$core$IFn$_invoke$arity$2(reagent.ratom.RAtom,expr__22492) : pred__22491.call(null,reagent.ratom.RAtom,expr__22492)))){
return "ra";
} else {
if(cljs.core.truth_((pred__22491.cljs$core$IFn$_invoke$arity$2 ? pred__22491.cljs$core$IFn$_invoke$arity$2(reagent.ratom.RCursor,expr__22492) : pred__22491.call(null,reagent.ratom.RCursor,expr__22492)))){
return "rc";
} else {
if(cljs.core.truth_((pred__22491.cljs$core$IFn$_invoke$arity$2 ? pred__22491.cljs$core$IFn$_invoke$arity$2(reagent.ratom.Reaction,expr__22492) : pred__22491.call(null,reagent.ratom.Reaction,expr__22492)))){
return "rx";
} else {
if(cljs.core.truth_((pred__22491.cljs$core$IFn$_invoke$arity$2 ? pred__22491.cljs$core$IFn$_invoke$arity$2(reagent.ratom.Track,expr__22492) : pred__22491.call(null,reagent.ratom.Track,expr__22492)))){
return "tr";
} else {
return "other";
}
