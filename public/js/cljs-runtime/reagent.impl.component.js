...
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__21927 = c;
var G__21927__$1 = (((G__21927 == null))?null:G__21927.prototype);
if((G__21927__$1 == null)){
return null;
} else {
return G__21927__$1.reagentRender;
}
})() == null)))));
});
reagent.impl.component.react_class_QMARK_ = (function reagent$impl$component$react_class_QMARK_(c){
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__21928 = c;
var G__21928__$1 = (((G__21928 == null))?null:G__21928.prototype);
if((G__21928__$1 == null)){
return null;
} else {
return G__21928__$1.render;
}
})() == null)))));
});
...
return (function() { 
var G__22088__delegate = function (args){
...
while (G__22089__i < G__22089__a.length) {G__22089__a[G__22089__i] = arguments[G__22089__i + 0]; ++G__22089__i;}
  args = new cljs.core.IndexedSeq(G__22089__a,0,null);
} 
...
var args = cljs.core.seq(arglist__22090);
...
var or__4998__auto__ = (function (){var G__21937 = c;
var G__21937__$1 = (((G__21937 == null))?null:G__21937.constructor);
if((G__21937__$1 == null)){
return null;
} else {
return G__21937__$1.displayName;
}
})();
...
var G__21938 = c;
var G__21938__$1 = (((G__21938 == null))?null:G__21938.constructor);
if((G__21938__$1 == null)){
return null;
} else {
return G__21938__$1.name;
}
}
});
...
var _STAR_current_component_STAR__orig_val__21945 = reagent.impl.component._STAR_current_component_STAR_;
var _STAR_current_component_STAR__temp_val__21946 = c;
(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__temp_val__21946);

try{return reagent.impl.component.wrap_render(c,compiler);
}finally {(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__orig_val__21945);
}});
reagent.impl.component.rat_opts = new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"no-cache","no-cache",1588056370),true], null);
reagent.impl.component.custom_wrapper = (function reagent$impl$component$custom_wrapper(key,f){
var G__21953 = key;
var G__21953__$1 = (((G__21953 instanceof cljs.core.Keyword))?G__21953.fqn:null);
switch (G__21953__$1) {
...
var or__4998__auto__ = reagent.impl.util._STAR_always_update_STAR_;
if(cljs.core.truth_(or__4998__auto__)){
return or__4998__auto__;
} else {
var c = this;
...
if((f == null)){
var or__4998__auto____$1 = noargv;
...
var c = this;
var G__21962_22099 = reagent.impl.component.goog$module$goog$object.get(c,"cljsRatom");
if((G__21962_22099 == null)){
} else {
reagent.ratom.dispose_BANG_(G__21962_22099);
}
...
var renders_22100 = cljs.core.select_keys(fmap,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"render","render",-1408033454),new cljs.core.Keyword(null,"reagentRender","reagentRender",-358306383)], null));
var render_fun_22101 = cljs.core.first(cljs.core.vals(renders_22100));
...
if((cljs.core.count(renders_22100) > (0))){
} else {
throw (new Error(["Assert failed: ","Missing reagent-render","\n","(pos? (count renders))"].join('')));
}

if(((1) === cljs.core.count(renders_22100))){
} else {
throw (new Error(["Assert failed: ","Too many render functions supplied","\n","(== 1 (count renders))"].join('')));
}

if(cljs.core.ifn_QMARK_(render_fun_22101)){
} else {
throw (new Error(["Assert failed: ",["Expected something callable, not ",cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([render_fun_22101], 0))].join(''),"\n","(clojure.core/ifn? render-fun)"].join('')));
}


var render_fun = (function (){var or__4998__auto__ = new cljs.core.Keyword(null,"reagentRender","reagentRender",-358306383).cljs$core$IFn$_invoke$arity$1(fmap);
if(cljs.core.truth_(or__4998__auto__)){
return or__4998__auto__;
} else {
...
var name = (function (){var or__4998__auto__ = new cljs.core.Keyword(null,"displayName","displayName",-809144601).cljs$core$IFn$_invoke$arity$1(fmap);
if(cljs.core.truth_(or__4998__auto__)){
return or__4998__auto__;
} else {
var or__4998__auto____$1 = reagent.impl.util.fun_name(render_fun);
...
var G__21978 = o;
reagent.impl.component.goog$module$goog$object.set(G__21978,cljs.core.name(k),v);
...
if(reagent.debug.has_console){
((reagent.debug.tracking)?reagent.debug.track_console:console).warn(["Warning: ","Using native React classes directly in Hiccup forms ","is not supported. Use create-element or ","adapt-react-class instead: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1((function (){var or__4998__auto__ = reagent.impl.util.fun_name(f);
if(cljs.core.truth_(or__4998__auto__)){
return or__4998__auto__;
} else {
return f;
...
return (function() { 
var G__22119__delegate = function (args){
return reagent.impl.protocols.as_element(compiler,cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.vector,res,args));
};
var G__22119 = function (var_args){
var args = null;
if (arguments.length > 0) {
...
while (G__22120__i < G__22120__a.length) {G__22120__a[G__22120__i] = arguments[G__22120__i + 0]; ++G__22120__i;}
  args = new cljs.core.IndexedSeq(G__22120__a,0,null);
} 
return G__22119__delegate.call(this,args);};
G__22119.cljs$lang$maxFixedArity = 0;
G__22119.cljs$lang$applyTo = (function (arglist__22121){
var args = cljs.core.seq(arglist__22121);
return G__22119__delegate(args);
});
...
var _STAR_current_component_STAR__orig_val__22007 = reagent.impl.component._STAR_current_component_STAR_;
var _STAR_current_component_STAR__temp_val__22008 = c;
(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__temp_val__22008);

try{return reagent.impl.component.functional_wrap_render(compiler,c);
}finally {(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__orig_val__22007);
}});
...
var vec__22027 = module$node_modules$react$index.useState((0));
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22027,(0),null);
var update_count = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22027,(1),null);
...
var G__22030 = reagent.impl.component.goog$module$goog$object.get(reagent_state,"cljsRatom");
if((G__22030 == null)){
return null;
} else {
return reagent.ratom.dispose_BANG_(G__22030);
}
});
}),[]);
...
var and__4996__auto__ = reagent.impl.util._STAR_always_update_STAR_ === false;
if(and__4996__auto__){
try{return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(old_argv,new_argv);
}catch (e22031){var e = e22031;
if(reagent.debug.has_console){
((reagent.debug.tracking)?reagent.debug.track_console:console).warn(["Warning: ","Exception thrown while comparing argv's in shouldComponentUpdate: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(old_argv)," ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(new_argv)," ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(e)].join(''));
} else {
}
...
var or__4998__auto__ = reagent.impl.component.cached_react_class(compiler,tag);
if(cljs.core.truth_(or__4998__auto__)){
return or__4998__auto__;
} else {
