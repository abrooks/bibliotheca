...
reagent.impl.input.input_node_set_value = (function reagent$impl$input$input_node_set_value(node,rendered_value,dom_value,component,p__22067){
var map__22069 = p__22067;
var map__22069__$1 = cljs.core.__destructure_map(map__22069);
var on_write = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22069__$1,new cljs.core.Keyword(null,"on-write","on-write",31519475));
if(cljs.core.truth_((function (){var or__4998__auto__ = (!((((node === document.activeElement)) && (((reagent.impl.input.has_selection_api_QMARK_(node.type)) && (((typeof rendered_value === 'string') && (typeof dom_value === 'string'))))))));
if(or__4998__auto__){
...
var _STAR_force_set_dom_value_STAR__orig_val__22074 = reagent.impl.input._STAR_force_set_dom_value_STAR_;
var _STAR_force_set_dom_value_STAR__temp_val__22075 = true;
(reagent.impl.input._STAR_force_set_dom_value_STAR_ = _STAR_force_set_dom_value_STAR__temp_val__22075);
...
}finally {(reagent.impl.input._STAR_force_set_dom_value_STAR_ = _STAR_force_set_dom_value_STAR__orig_val__22074);
}}));
} else {
...
if(cljs.core.truth_((function (){var and__4996__auto__ = (!((jsprops == null)));
if(and__4996__auto__){
var and__4996__auto____$1 = jsprops.hasOwnProperty("onChange");
...
}):(cljs.core.truth_((function (){var and__4996__auto__ = original_ref_fn;
...
(jsprops.onChange = (function (p1__22093_SHARP_){
return reagent.impl.input.input_handle_change(this$,on_change,p1__22093_SHARP_);
}));
