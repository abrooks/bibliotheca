...
ajax.transit.transit_type = (function ajax$transit$transit_type(p__24412){
var map__24413 = p__24412;
var map__24413__$1 = cljs.core.__destructure_map(map__24413);
var type = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__24413__$1,new cljs.core.Keyword(null,"type","type",1174270348));
var or__4998__auto__ = type;
...
var writer = (function (){var or__4998__auto__ = new cljs.core.Keyword(null,"writer","writer",-277568236).cljs$core$IFn$_invoke$arity$1(opts);
if(cljs.core.truth_(or__4998__auto__)){
return or__4998__auto__;
} else {
...
var reader = (function (){var or__4998__auto__ = new cljs.core.Keyword(null,"reader","reader",169660853).cljs$core$IFn$_invoke$arity$1(opts);
if(cljs.core.truth_(or__4998__auto__)){
return or__4998__auto__;
} else {
