...
return cljs.core._write(writer__5284__auto__,"cljs.core.async.impl.timers/SkipListNode");
}));
...
var i_27842 = (0);
while(true){
if((i_27842 < arr.length)){
(arr[i_27842] = null);

var G__27845 = (i_27842 + (1));
i_27842 = G__27845;
continue;
} else {
}
...
var i_27859 = (self__.level + (1));
while(true){
if((i_27859 <= (new_level + (1)))){
(update[i_27859] = self__.header);

var G__27860 = (i_27859 + (1));
i_27859 = G__27860;
continue;
} else {
}
...
while(true){
if((i <= self__.level)){
var links_27861 = (update[i]).forward;
if((i < x__$2.forward.length)){
(x__$2.forward[i] = (links_27861[i]));
} else {
x__$2.forward.push((((i < links_27861.length))?(links_27861[i]):null));
}

if((i < links_27861.length)){
(links_27861[i] = x__$2);
} else {
links_27861.push(x__$2);
}
...
var i_27864 = (0);
while(true){
if((i_27864 <= self__.level)){
var links_27865 = (update[i_27864]).forward;
if((x__$1 === (((i_27864 < links_27865.length))?(links_27865[i_27864]):null))){
(links_27865[i_27864] = (x__$1.forward[i_27864]));

var G__27868 = (i_27864 + (1));
i_27864 = G__27868;
continue;
} else {
var G__27870 = (i_27864 + (1));
i_27864 = G__27870;
continue;
}
} else {
...
if(cljs.core.truth_(nx)){
var G__27920 = nx;
var G__27921 = (level__$1 - (1));
x = G__27920;
level__$1 = G__27921;
continue;
} else {
var G__27922 = x;
var G__27923 = (level__$1 - (1));
x = G__27922;
level__$1 = G__27923;
continue;
}
...
return cljs.core._write(writer__5284__auto__,"cljs.core.async.impl.timers/SkipList");
}));
...
var or__4998__auto__ = (cljs.core.truth_((function (){var and__4996__auto__ = me;
